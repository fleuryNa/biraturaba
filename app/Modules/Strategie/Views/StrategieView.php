...
<body class="fixed-navbar">
            ...
            <div class="content">
                ...
                <div class="page-heading">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">Objectifs</li>
                    </ol>
                </div>
                ...
                <div class="page-content fade-in-up">
                    ...
                    <div class="ibox">
                        ...
                        <div class="ibox-head d-flex justify-content-between align-items-center">
                            <div class="ibox-title">Objectifs</div>

                            <div>
                                <button class="lodge-primary" onclick="openAddObjectifModal()">
                                    Nouveau
                                </button>
                            </div>
                        </div>
                        <div class="ibox-body">
                            <div class="table-responsive">
                                <div class="table-responsive">
                                    <table id="objectifTable" class="table table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                <th>Titre</th>
    ...
    <div class="modal fade" id="objectifModal" tabindex="-1" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title">
                        <strong id="modalTitle">Ajouter un objectif</strong>
                    </h5>
                ...
                <div class="modal-body">
                    ...
                    <form id="objectifForm" enctype="multipart/form-data">

                        <input type="hidden" name="ID_OBJECTIF" id="ID_OBJECTIF">
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn btn-primary" onclick="saveObjectif(event)">
    ...
    function loadObjectifsData() {
        ...
        $('#objectifTable').DataTable({
            ...
            "ajax": {
                url: "<?php echo base_url('objectifs/liste') ?>",
                type: "POST",
                data: {}
            },
            lengthMenu: [
    ...
    function saveObjectif(e) {
        ...
        let form = $('#objectifForm')[0];

        let data = new FormData(form);

        $.ajax({
            url: "<?= base_url('objectifs/store') ?>",
            type: "POST",
            data: data,
            processData: false,
            contentType: false,
            ...
            success: function(res) {
                ...
                if (res.success) {
                    ...
                    $('#objectifModal').modal('hide');

                    $('#objectifTable').DataTable().ajax.reload();
    ...
    function resetObjectifForm() {
        $('#objectifForm')[0].reset();
        $('#ID_OBJECTIF').val('');
        $('#previewImage').attr('src', '');
        $('#modalTitle').text('Ajouter un objectif');
    }

    function openAddObjectifModal() {
        $('#objectifForm')[0].reset();
        $('#ID_OBJECTIF').val('');
    ...
    function editObjectif(id) {
        ...
        $.ajax({
            ...
            url: "<?= base_url('objectifs/getOne/') ?>" + id,
            type: "GET",
            dataType: "json",
            ...
            success: function(res) {
                ...
                if (d.IMAGE) {
                    ...
                    $('#previewImage')
                        .attr(
                            'src',
                            "<?= base_url('uploads/objectifs/') ?>" + d.IMAGE
                        )
                        .show();
                }

                $('#modalTitle').text('Modifier objectif');

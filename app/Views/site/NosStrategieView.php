                ...
                <div class="col-lg-8 col-sm-12 col-xs-12">
                    <div class="post-slide-blog">
                        ...
                        <p>It is a long established fact that a reader will be distracted by the readable content of a
                            page when looking at its layout. The point of using is that it has a more-or-less normal
                            distribution of letters, as opposed to using here making it look like readable English. Many
                            desktop publishing packages. <br /><br />
                            It is a long established fact that a reader will be distracted by the readable content of a
                            page when looking at its layout. The point of using is that it has a more-or-less normal
                            distribution of letters, as opposed to using here making it look like readable English. Many
                            desktop publishing packages.</p>
                        <p class="bc_left">The point of using is that it has a more-or-less normal distribution of
                            letters, as opposed to using here making it look like readable English.</p>
                    </div>
                    <div class="author_part">
                        <h3 class="blog_head_title">About the author</h3>
                        <div class="single_author">
                            <img src="<?= base_url()?>public/assetsfront/img/blog/author.jpg" alt="" />
                            <h4>Marina Mojo</h4>
                    ...
                    <div class="comments_part">
                        ...
                        <div class="single_comment">
                            <img src="<?= base_url()?>public/assetsfront/img/blog/c1.jpg" alt="" />
                        ...
                        <div class="single_comment single_comment_mbnone">
                            <img src="<?= base_url()?>public/assetsfront/img/blog/c2.jpg" alt="" />
                            <h4>Mark Linomi</h4>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent ultricies quam nisi,
                                vel gravida enim accumsan id. Praesent justo quam, auctor et lorem in, pulvinar ornare
                                orci.</p>
                                    ...
                                    <div class="col-md-12">
                                        <div class="actions">
                                            <button type="submit" value="Send message" name="submit" id="submitButton"
                                                class="btn btn-lg btn_one" title="Submit Your Message!">Submit
                                                Comment</button>
                                        </div>
                                    </div>
                                </div>

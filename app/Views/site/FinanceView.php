...
<body data-spy="scroll" data-offset="80">
    ...
    <section class="marketing_area section-padding">
        <div class="container">
            <div class="row">
                <div class="col-lg-5 col-sm-12 col-xs-12 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s"
                    data-wow-offset="0">
                    <div class="marketing_content">
                        <h2>Email Marketing is one of the best way to reach real customer to sale your product easily.
                        </h2>
                        <img src="assetsfront/img/marketing.png" class="img-fluid" alt="marketing-image" />
                    </div>
                </div><!-- END COL -->
                <div class="col-lg-7 col-sm-12 col-xs-12 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s"
                    ...
                    <div class="marketing_text">
                        ...
                        <p>Ever since the when an unknown printer took a galley of type and scrambled it to make a type
                            specimen book. It is a long established fact that a reader. It was popularised in the with
                            the release.</p>
                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has
                            been the industry standard dummy text ever since the when an unknown printer took a galley
                            of type and scrambled it to make a type specimen book. It is a long established fact that a
                            reader. It was popularised in the with the release.Lorem Ipsum is simply dummy text of the
                            printing and typesetting industry. Lorem Ipsum has been the industry standard dummy text
                            ever since the when an unknown printer took a galley of type and scrambled it to make a type
                            specimen book. It is a long established fact that a reader. It was popularised in the with
                            the release.</p>
                    </div>
                </div><!-- END COL -->
                ...
                <div class="col-lg-10 offset-lg-1 col-sm-12 col-xs-12">
                    <div class="row">
                        <div class="col-lg-6 col-sm-12 col-xs-12 wow fadeInUp" data-wow-duration="1s"
                            ...
                            <div class="single_marketing">
                                <div class="marketing_icon_img">
                                    <img src="assetsfront/img/icon/marketing-1.png" alt="marketing-icon-image" />
                                </div>
                        ...
                        <div class="col-lg-6 col-sm-12 col-xs-12 wow fadeInUp" data-wow-duration="1s"
                            ...
                            <div class="single_marketing">
                                <div class="marketing_icon_img">
                                    <img src="assetsfront/img/icon/envelope.png" alt="marketing-icon-image" />
                                </div>
                        ...
                        <div class="col-lg-6 col-sm-12 col-xs-12 wow fadeInUp" data-wow-duration="1s"
                            ...
                            <div class="single_marketing">
                                <div class="marketing_icon_img">
                                    <img src="assetsfront/img/icon/cart.png" alt="marketing-icon-image" />
                                </div>
                        ...
                        <div class="col-lg-6 col-sm-12 col-xs-12 wow fadeInUp" data-wow-duration="1s"
                            ...
                            <div class="single_marketing">
                                <div class="marketing_icon_img">
                                    <img src="assetsfront/img/icon/sales.png" alt="marketing-icon-image" />
                                </div>
                ...
                <div class="col-lg-10 offset-lg-1 col-sm-12 col-xs-12">
                    <div class="row">
                        <div class="col-lg-6 col-sm-12 col-xs-12 wow fadeInUp" data-wow-duration="1s"
                            ...
                            <div class="single_testimonial">
                                <div class="testimonial_img">
                                    <img src="assetsfront/img/testimonial/1.jpg" alt="testimonial-image" />
                                </div>
                                <p>Sed do eiusmod tempor incididunt ut labore. Lorem ipsum dolor sit amet, consectetur
                                    adipisicing elit, sed do eiusmod tempor ut labore.</p>
                                <h4>Alex Chohan</h4>
                        ...
                        <div class="col-lg-6 col-sm-12 col-xs-12 wow fadeInUp" data-wow-duration="1s"
                            ...
                            <div class="single_testimonial">
                                <div class="testimonial_img">
                                    <img src="assetsfront/img/testimonial/2.jpg" alt="testimonial-image" />
                                </div>
                                <p>Sed do eiusmod tempor incididunt ut labore. Lorem ipsum dolor sit amet, consectetur
                                    adipisicing elit, sed do eiusmod tempor ut labore.</p>
                                <h4>Johnson Brown</h4>
                        ...
                        <div class="col-lg-6 col-sm-12 col-xs-12 wow fadeInUp" data-wow-duration="1s"
                            ...
                            <div class="single_testimonial">
                                <div class="testimonial_img">
                                    <img src="assetsfront/img/testimonial/3.jpg" alt="testimonial-image" />
                                </div>
                                <p>Sed do eiusmod tempor incididunt ut labore. Lorem ipsum dolor sit amet, consectetur
                                    adipisicing elit, sed do eiusmod tempor ut labore.</p>
                                <h4>Devid Miller</h4>
                        ...
                        <div class="col-lg-6 col-sm-12 col-xs-12 wow fadeInUp" data-wow-duration="1s"
                            ...
                            <div class="single_testimonial">
                                <div class="testimonial_img">
                                    <img src="assetsfront/img/testimonial/4.jpg" alt="testimonial-image" />
                                </div>
                                <p>Sed do eiusmod tempor incididunt ut labore. Lorem ipsum dolor sit amet, consectetur
                                    adipisicing elit, sed do eiusmod tempor ut labore.</p>
                                <h4>Maya Khan</h4>
            ...
            <div class="row text-center">
                <div class="col-lg-2 col-sm-4 col-xs-12 no-padding wow fadeInUp" data-wow-duration="1s"
                    ...
                    <div class="single_logo single_logo_bm">
                        <a href="#"><img src="assetsfront/img/partner/1.png" alt="" class="img-fluid" /></a>
                    </div>
                </div>
                <!--- END COL -->
                <div class="col-lg-2 col-sm-4 col-xs-12 no-padding wow fadeInUp" data-wow-duration="1s"
                ...
                <div class="col-lg-2 col-sm-4 col-xs-12 no-padding wow fadeInUp" data-wow-duration="1s"
                    ...
                    <div class="single_logo">
                        <a href="#"><img src="assetsfront/img/partner/5.png" alt="" class="img-fluid" /></a>
                    </div>
                </div>
                <!--- END COL -->
                <div class="col-lg-2 col-sm-4 col-xs-12 no-padding wow fadeInUp" data-wow-duration="1s"
                    ...
                    <div class="single_logo">
                        <a href="#"><img src="assetsfront/img/partner/6.png" alt="" class="img-fluid" /></a>
                    </div>
                </div>
                <!--- END COL -->
            </div>

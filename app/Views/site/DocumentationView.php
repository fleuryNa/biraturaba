...
<body data-spy="scroll" data-offset="80">
	...
	<section id="home" class="home_video html-video">				
		<video class="text-center" muted="" autoplay="" loop="">
			...
			<source type="video/webm" src="<?= base_url()?>public/assets/videos/video.webm">
				<!-- MP4 for Safari, IE9, iPhone, iPad, Android, and Windows Phone 7 -->
				<source type="video/mp4" src="<?= base_url()?>public/assets/videos/video.mp4">
				...
				<div class="container">										
					<div class="row text-center">
						...
						<div class="col-lg-2 col-sm-4 col-xs-12 no-padding wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.4s" data-wow-offset="0">
							<div class="single_logo">
								<a href="#"><img src="<?= base_url()?>public/<?= base_url()?>public/assets/img/partner/4.png" alt="" class="img-fluid"/></a>
							</div>						
						</div><!--- END COL -->
						<div class="col-lg-2 col-sm-4 col-xs-12 no-padding wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.5s" data-wow-offset="0">
							<div class="single_logo">
								<a href="#"><img src="<?= base_url()?>public/<?= base_url()?>public/assets/img/partner/5.png" alt="" class="img-fluid"/></a>
							</div>						
						</div><!--- END COL -->

			...
			<div class="row">
				<div class="col-lg-12 col-sm-12 col-xs-12">
					<div class="single_project">
						<img src="<?= base_url()?>public/assets/img/portfolio/1.jpg" class="img-fluid" alt="portfolio" />
						<h1>01</h1>
				...
				<div class="col-lg-12 col-sm-12 col-xs-12">
					<div class="single_project">
						<img src="<?= base_url()?>public/assets/img/portfolio/2.jpg" class="img-fluid" alt="portfolio" />
						<h1>02</h1>
				...
				<div class="col-lg-12 col-sm-12 col-xs-12">
					<div class="single_project">
						<img src="<?= base_url()?>public/assets/img/portfolio/3.jpg" class="img-fluid" alt="portfolio" />
						<h1>03</h1>
				...
				<div class="col-lg-12 col-sm-12 col-xs-12">
					<div class="single_project">
						<img src="<?= base_url()?>public/assets/img/portfolio/4.jpg" class="img-fluid" alt="portfolio" />
						<h1>04</h1>

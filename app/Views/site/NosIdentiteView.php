...
<body data-spy="scroll" data-offset="80">
	...
	<!-- START PRICING TABLE -->
	<div class="pricing-table-area section-padding" style="background-image: url(public/assets/img/bg/pricing-bg.jpg);  background-size:cover;background-position:center;">
		<div class="container">										
			...
			<div class="row text-center">
				<div class="col-lg-2 col-sm-4 col-xs-12 no-padding wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s" data-wow-offset="0">
					<div class="single_logo single_logo_bm">
						<a href="#"><img style="height: 50px;width: 50px;" src="<?= base_url()?>public/assets/img/partner/1.png" alt="" class="img-fluid"/></a>
					</div>						
				</div><!--- END COL -->

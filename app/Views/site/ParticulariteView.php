...
<body data-spy="scroll" data-offset="80">
    ...
    <!-- START BLOG -->
    <?php foreach ($particularites as $key => $particularite): ?>
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 wow fadeInLeft" data-wow-duration="1s">
                    <div class="about_img">
                        <img src="<?= base_url('uploads/particularite/' . $particularite['IMAGE']) ?>"
                            class="img-fluid rounded shadow" alt="<?= esc($particularite['TITRE']) ?>">
                    </div>
                </div>

                <div class="col-lg-6 wow fadeInRight" data-wow-duration="1s">
                    <div class="about_content">
                        <h3><?= esc($particularite['TITRE']) ?></h3>
                        <p><?= esc($particularite['DESCRIPTION']) ?></p>
                    </div>
                </div>

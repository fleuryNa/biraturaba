...
<body data-spy="scroll" data-offset="80">
	...
	<div id="kenburns_061" class="carousel slide ps_indicators_txt_icon ps_control_txt_icon data-bs-target kbrns_zoomInOut thumb_scroll_x swipe_x ps_easeOutQuart" data-ride="carousel" data-pause="hover" data-interval="10000" data-duration="2000">
		...
		<div class="carousel-inner" role="listbox">
			...
			<div class="carousel-item active">
				<!-- Slide Background -->
				<img src="<?= base_url()?>public/assets/img/bg/1.jpg" alt="slider-image" />
			...
			<div class="carousel-item">
				<!-- Slide Background -->
				<img src="<?= base_url()?>public/assets/img/bg/2.jpg" alt="slider-image" />
			...
			<div class="carousel-item">
				<!-- Slide Background -->
				<img src="<?= base_url()?>public/assets/img/bg/3.jpg" alt="slider-image" />
			...
			<div class="row">
				<div class="col-lg-6 col-sm-12 col-xs-12 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s" data-wow-offset="0">
					<div class="single_why_choose">
						...
						<a class="btn_one" href="<?= base_url('histoire')?>">Learn More</a>
					</div>							
				</div><!--- END COL -->	
				<div class="col-lg-6 col-sm-12 col-xs-12 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s" data-wow-offset="0">
	...
	<!-- SKILLS -->
	<section class="skills_area section-padding" style="background-image: url(<?= base_url()?>public/assets/img/bg/skill-bg.jpg);  background-size:cover;background-position:center;">   
		<div class="container">				
			<div class="row">					

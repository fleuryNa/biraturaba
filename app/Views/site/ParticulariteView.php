...
<body data-spy="scroll" data-offset="80">
    ...
    <div id="kenburns_061"
        ...
        <div class="carousel-inner" role="listbox">
            ...
            <div class="carousel-item active">
                <!-- Slide Background -->
                <img src="<?= base_url()?>public/assetsfront/img/bg/1.jpg" alt="slider-image" />
            ...
            <div class="carousel-item">
                <!-- Slide Background -->
                <img src="<?= base_url()?>public/assetsfront/img/bg/2.jpg" alt="slider-image" />
            ...
            <div class="carousel-item">
                <!-- Slide Background -->
                <img src="<?= base_url()?>public/assetsfront/img/bg/3.jpg" alt="slider-image" />
    ...
    <section class="skills_area section-padding"
        style="background-image: url(<?= base_url()?>public/assetsfront/img/bg/skill-bg.jpg);  background-size:cover;background-position:center;">
        <div class="container">
            <div class="row">

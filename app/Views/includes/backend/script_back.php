...
<script src="<?= base_url()?>/public/dist/datatables/dataTables.buttons.min.js"></script>
<script src="<?= base_url()?>/public/dist/datatables/buttons.html5.min.js"></script>
<script src="<?= base_url()?>/public/dist/datatables/buttons.print.min.js"></script>

<script src="<?= base_url()?>/public/dist/datatables/jszip.min.js"></script>
<script src="<?= base_url()?>/public/dist/datatables/pdfmake.min.js"></script>
<script src="<?= base_url()?>/public/dist/datatables/vfs_fonts.js"></script>
